...
<div class="vertical-tabs">
  ...
  <div class="sidebar-section meta">
    <h3>Meta</h3>
    <p class="tags"><i class="fa fa-tags"></i> tag, another_tag, another</p>
  </div>
</div>
...
<div class="vertical-tab-content-container">
  ...
  <div id="tab2" class="js-vertical-tab-content vertical-tab-content">
    ...
    <p>To run <em>Package Verbose Name</em>, you will need to have the following packages installed:</p>
    ...
    <table class="package-downloads">
      <thead>
        <tr>
          ...
          <th class="checksum">MD5 Checksum <a href=""><i class="fa fa-question-circle"></i></a></th>
      ...
      <tbody>
        <tr>
          <td><a href="#">pykd-0.3.0.33-cp27-none-win32.whl</a> (2MB)</td>
          <td>ff216db51f7ee12d2d2e4e8fd6899ce8<a class="md5-link" href="clicking-here-copies-md5"><i class="fa fa-copy"></i></a>
          </td>
          <td>Wheel</td>
          <td>Oct 22, 2015</td>
          <td>cp27</td>
